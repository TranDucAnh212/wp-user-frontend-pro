                        ...
                        if ( $items ) {
                            ...
                            <tr>
                                <?php for ( $count = 0; $count < $num_columns; $count++ ) { ?>
                                    <td>
                                        <input type="text" name="<?php echo $field_settings['name'] . '[' . $count . ']'; ?>[]" value="<?php echo esc_attr( $column_vals[$count] ); ?>" size="<?php echo esc_attr( $field_settings['size'] ) ?>" data-required="<?php echo $field_settings['required'] ?>" data-type="text"
